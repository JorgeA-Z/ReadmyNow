    ...
    <nav>
      <div class="d-flex m-1 contenedor">
        ...
        <div class="botones">
          ...
          <svg id="prev" @click="prev()" xmlns="http://www.w3.org/2000/svg" width="70" height="45" viewBox="0 0 67 44" fill="none" class="pe-2 flechas" >
            <path d="M33.5 14.6667L22.3333 22M22.3333 22L33.5 29.3333M22.3333 22H44.6667M21.775 38.5H45.225C49.9154 38.5 52.2607 38.5 54.0522 37.9005C55.628 37.3732 56.9092 36.5318 57.7122 35.4969C58.625 34.3204 58.625 32.7803 58.625 29.7V14.3C58.625 11.2197 58.625 9.67957 57.7122 8.50305C56.9092 7.46816 55.628 6.62677 54.0522 6.09946C52.2607 5.5 49.9154 5.5 45.225 5.5H21.775C17.0846 5.5 14.7393 5.5 12.9478 6.09946C11.372 6.62677 10.0908 7.46816 9.28782 8.50305C8.375 9.67957 8.375 11.2197 8.375 14.3V29.7C8.375 32.7803 8.375 34.3204 9.28782 35.4969C10.0908 36.5318 11.372 37.3732 12.9478 37.9005C14.7393 38.5 17.0846 38.5 21.775 38.5Z" stroke="#7A60A9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>

          <h5 class="m-0 readme">ReadMeNow!</h5>

          <svg id="next" @click="next()" xmlns="http://www.w3.org/2000/svg" width="70" height="45" viewBox="0 0 67 44" fill="none" class="ps-2 flechas">
            <path d="M33.5 29.3333L44.6667 22M44.6667 22L33.5 14.6667M44.6667 22H22.3333M21.775 38.5H45.225C49.9154 38.5 52.2607 38.5 54.0522 37.9005C55.628 37.3732 56.9092 36.5318 57.7122 35.4969C58.625 34.3204 58.625 32.7803 58.625 29.7V14.3C58.625 11.2197 58.625 9.67957 57.7122 8.50305C56.9092 7.46816 55.628 6.62677 54.0522 6.09946C52.2607 5.5 49.9154 5.5 45.225 5.5H21.775C17.0846 5.5 14.7393 5.5 12.9478 6.09946C11.372 6.62677 10.0908 7.46816 9.28782 8.50305C8.375 9.67957 8.375 11.2197 8.375 14.3V29.7C8.375 32.7803 8.375 34.3204 9.28782 35.4969C10.0908 36.5318 11.372 37.3732 12.9478 37.9005C14.7393 38.5 17.0846 38.5 21.775 38.5Z" stroke="#7A60A9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        ...
        <div class="m-0">
          ...
          <svg v-if="bookmark" @click="marcador" xmlns="http://www.w3.org/2000/svg" width="50" height="41" viewBox="0 0 50 41" fill="none" class="marcador">
          <g opacity="0.2">
            <path d="M32.8125 35.875L21.8736 29.4688L10.9375 35.875V11.5313C10.9375 11.1914 11.1021 10.8656 11.3951 10.6253C11.6882 10.385 12.0856 10.25 12.5 10.25H31.25C31.6644 10.25 32.0618 10.385 32.3549 10.6253C32.6479 10.8656 32.8125 11.1914 32.8125 11.5313V35.875Z" fill="#7A60A9"/>
          </g>
          <path d="M31.25 8.96875H12.5C11.6715 8.96953 10.8772 9.23975 10.2913 9.72015C9.70549 10.2005 9.37595 10.8519 9.375 11.5312V35.875C9.37501 36.1104 9.45412 36.3413 9.60364 36.5423C9.75315 36.7432 9.96731 36.9065 10.2226 37.0143C10.4779 37.122 10.7644 37.1699 11.0507 37.1529C11.3371 37.1358 11.6122 37.0544 11.8458 36.9176L21.8737 31.0433L31.9044 36.9176C32.138 37.0544 32.4131 37.1358 32.6994 37.1529C32.9857 37.1699 33.2723 37.122 33.5275 37.0142C33.7828 36.9065 33.9969 36.7432 34.1464 36.5422C34.2959 36.3413 34.375 36.1104 34.375 35.875V11.5312C34.3741 10.8519 34.0445 10.2005 33.4587 9.72015C32.8728 9.23975 32.0785 8.96953 31.25 8.96875ZM31.25 33.3855L22.7817 28.4262C22.5167 28.2709 22.1991 28.1875 21.8735 28.1875C21.5478 28.1875 21.2303 28.2709 20.9653 28.4262L12.5 33.3851V11.5312H31.25V33.3855Z" fill="#7A60A9"/>
          <path d="M37.5 3.84375H17.1875C16.7731 3.84375 16.3757 3.97874 16.0826 4.21902C15.7896 4.4593 15.625 4.78519 15.625 5.125C15.625 5.46481 15.7896 5.7907 16.0826 6.03098C16.3757 6.27126 16.7731 6.40625 17.1875 6.40625H37.5V30.75C37.5 31.0898 37.6646 31.4157 37.9576 31.656C38.2507 31.8963 38.6481 32.0312 39.0625 32.0312C39.4769 32.0312 39.8743 31.8963 40.1674 31.656C40.4604 31.4157 40.625 31.0898 40.625 30.75V6.40625C40.6241 5.72687 40.2945 5.07554 39.7087 4.59515C39.1228 4.11475 38.3285 3.84453 37.5 3.84375Z" fill="#7A60A9"/>
        </svg>

        <svg v-else @click="marcador" xmlns="http://www.w3.org/2000/svg" width="50" height="41" viewBox="0 0 50 41" fill="none" class="marcador">
          <g opacity="0.2">
            <path d="M32.8125 35.875L21.8736 29.4688L10.9375 35.875V11.5313C10.9375 11.1914 11.1021 10.8656 11.3951 10.6253C11.6882 10.385 12.0856 10.25 12.5 10.25H31.25C31.6644 10.25 32.0618 10.385 32.3549 10.6253C32.6479 10.8656 32.8125 11.1914 32.8125 11.5313V35.875Z" fill="#7A60A9"/>
          </g>
          <path d="M31.25 8.96875H12.5C11.6715 8.96953 10.8772 9.23975 10.2913 9.72015C9.70549 10.2005 9.37595 10.8519 9.375 11.5312V35.875C9.37501 36.1104 9.45412 36.3413 9.60364 36.5423C9.75315 36.7432 9.96731 36.9065 10.2226 37.0143C10.4779 37.122 10.7644 37.1699 11.0507 37.1529C11.3371 37.1358 11.6122 37.0544 11.8458 36.9176L21.8737 31.0433L31.9044 36.9176C32.138 37.0544 32.4131 37.1358 32.6994 37.1529C32.9857 37.1699 33.2723 37.122 33.5275 37.0142C33.7828 36.9065 33.9969 36.7432 34.1464 36.5422C34.2959 36.3413 34.375 36.1104 34.375 35.875V11.5312C34.3741 10.8519 34.0445 10.2005 33.4587 9.72015C32.8728 9.23975 32.0785 8.96953 31.25 8.96875ZM31.25 33.3855L22.7817 28.4262C22.5167 28.2709 22.1991 28.1875 21.8735 28.1875C21.5478 28.1875 21.2303 28.2709 20.9653 28.4262L12.5 33.3851V11.5312H31.25V33.3855Z" fill="#7A60A9"/>
