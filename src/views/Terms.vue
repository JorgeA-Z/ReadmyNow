...
<template>
  ...
  <div class="container">
    <h4 class="m-4 text-center terms__title">Terms and Conditions</h4>

    <div class="row justify-content-center">
      <div class="mb-3 card terms__card">
        <div class="card-body">
          ...
          <p>
            ...
            nuestros productos. readmynow.com no asume la responsabilidad en
          ...
          <p>
            ReadMeNow&nbsp; a través de su sitio web concede una licencia para
          ...
          <p>
            Este readmynow.com garantiza que la
            <a href="" target="_blank"></a> información personal que usted envía
          ...
          <p>
            ReadMeNow reserva los derechos de cambiar o de modificar estos
